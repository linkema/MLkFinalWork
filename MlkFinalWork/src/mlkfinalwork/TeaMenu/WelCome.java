...
import mlkfinalwork.TeaUtils.MyLookAndFeel;
...
public class WelCome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(58, 168, 0));
        ...
        jLabel1.setText(" 教师工资管理系统");

        jLabel2.setText("Copyright@YasanMa");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        TeaNewsOutput tno=new TeaNewsOutput();
        this.dispose();
        tno.setVisible(true);
